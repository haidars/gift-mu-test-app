...
<section class="${"todos pt-10 pb-3 px-4 svelte-16nsat"}"><h1 class="${"text-5xl text-center"}">Todos</h1>
	<div class="${"w-full flex items-center"}"><a href="${"/"}" class="${"flex items-center justify-center bg-blue-500 px-3 py-2 rounded-3xl text-white"}"><span>Back to Home page</span></a></div>
...
//# sourceMappingURL=_page.svelte-ZMSE35JJ.js.map
